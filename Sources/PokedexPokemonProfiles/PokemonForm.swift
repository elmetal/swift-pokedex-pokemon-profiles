...
public extension PokemonForm {
    ...
    static let burn = PokemonForm(rawValue: "burn")
    static let c = PokemonForm(rawValue: "c")
    static let chill = PokemonForm(rawValue: "chill")
    ...
    static let douse = PokemonForm(rawValue: "douse")
    ...
    static let shock = PokemonForm(rawValue: "shock")
